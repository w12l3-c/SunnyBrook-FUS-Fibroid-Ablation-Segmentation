...
if __name__ == '__main__':
    ...
    try:
        ...
        unet_save_path = f"./trained_models/Unet_Coronal_{datetime.datetime.now().strftime('%Y-%m-%d_%H')}.pth"
    ...
    try:
        ...
        unet_save_path = './trained_models/Unet_Coronal_2023-08-01_18:02:56.pth'
